...
import { getAllExercises, getExerciseDetails, getExerciseHistory, getLastExercisePerformance, getLastExercisePerformances, getBestExercisePerformance } from '@/lib/dal'
...
export async function fetchLastExercisePerformances(ids: number[]) {
  return getLastExercisePerformances(ids)
}
